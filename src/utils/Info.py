...
from src.utils.GetAbis import (BRIDGE_ABI_PATH, ERC20_ABI_PATH, DAI_ABI_PATH, JEDISWAP_ABI_PATH, JEDISWAP_ETHUSDC_ABI_PATH, JEDISWAP_ETHUSDT_ABI_PATH, JEDISWAP_USDCUSDT_ABI_PATH, DMAIL_ABI_PATH, AVNUFI_ABI_PATH, STARKNETID_ABI_PATH, TENKSWAP_ABI_PATH, STARKVERSE_ABI_PATH, STARKNETIDNFT_ABI_PATH)
